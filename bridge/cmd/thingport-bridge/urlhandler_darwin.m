...
@interface TPBridgeAppDelegate : NSObject <NSApplicationDelegate>
@end

@implementation TPBridgeAppDelegate

// Registered in applicationWillFinishLaunching, not applicationDidFinishLaunching: when this
// process is launched *by* a thingport:// open (the common case -- the app isn't already
...
void RunURLListener(void) {
    @autoreleasepool {
        ...
        TPBridgeAppDelegate *delegate = [[TPBridgeAppDelegate alloc] init];
