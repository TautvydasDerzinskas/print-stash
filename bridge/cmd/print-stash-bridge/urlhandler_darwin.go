...
// loop -- handleGetURLEvent (urlhandler_darwin.m) calls back into it for every print-stash://
...
// that hands every print-stash:// open to handle. macOS reuses this running instance for
