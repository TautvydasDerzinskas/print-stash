// Pure/async 3D-asset loading logic used by the library route's ModelViewer and ModelSnapshot
// components. Nothing here depends on React -- it's plain three.js scene-graph construction plus
// fetch/WASM work (STL/3MF/STEP/OBJ parsing), which is why it lives in services/ rather than
// utils/. paletteForTheme()/applyThemeToObject() (material coloring) also live here since both
