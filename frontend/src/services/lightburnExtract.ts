...
// image entry) or a flat XML/binary file with an image embedded as raw bytes or base64 text. No
// React dependency, and it does real I/O-adjacent work (unzip, byte scanning of a fetched file),
// so it lives in services/ rather than utils/ alongside the other loader/extraction logic.
...
export async function extractLightBurnPreview(bytes: Uint8Array): Promise<PreviewPayload | null> {
